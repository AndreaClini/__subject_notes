...
\begin{align}
    ...
    \eta_\pm := V^{-\frac{1}{2}} \omega_k^{-\frac{1}{2}} P_\pm = \frac{1}{\sqrt{2}}(\eta_k \pm \eta_{-k}),\qquad [\xi_\pm]=[\eta_\pm]=E^0\,.
\end{align}
%
...
\end{align}
%
Everything is made rigorous by imposing IR regularization, so that Fourier modes $k$ become countable discrete and we get the changes \eqref{eq:IR_reg_replacements}.
