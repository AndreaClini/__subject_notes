...
{\small
\begin{align}\label{eq:orthogonality_condition_bogoliubov_coefficients}
...
{\small\begin{align}\label{eq:inverse_transformation_bogoliubov_modes}
    ...
    \end{array}
\end{align}}
More concisely, in matrix form, demanding both are simplectic (orthogonal complete) bases imposes\todotag{check}
{\small
\begin{align}\label{eq:bogol_transform_mode_function_matrix_form_classical}
    ...
    \begin{pmatrix}\tilde{u}_m\\ \tilde{u}_m^*\end{pmatrix},
    \quad\text{with}\qquad \begin{array}{c} \alpha\alpha^\dagger - \beta \beta^\dagger = \mathbb{I},\,\, \alpha\beta^T - \beta\alpha^T = 0, \\[2pt]
