...
\end{align}}
The \textbf{scattering operator} is the unitary operator relating the Fock spaces and ladder operators as
...
\end{align}}
Defining unitarily rotated ladder operators $b= V^T a$ and $\tilde{b}:= U^T\tilde{a}$, still obeying the CCR, we thus find
{\small\begin{align}
