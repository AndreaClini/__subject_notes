...
\end{equation}
Using analytic regularization (e.g. zeta-function with $\zeta(-3)=\tfrac{1}{120}$), one obtains the finite result
\begin{equation}
...
\begin{mytheorem}[Heisenberg canonical quantization procedure.\todotag{Modify}]
