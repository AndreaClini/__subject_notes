...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth]{images/3_corks_lake.png}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.45\textwidth}
    \raisebox{1em}[0pt][0pt]{%
      \includegraphics[width=\linewidth,height=3.5cm]{images/correlated_cork_oscillations.png}}
  \end{minipage}
\end{figure}
...
\end{equation}
In the original formulation it is bound to fail when dealing with systems with variable particle number.
%
...
%
The Klein-Gordon equation simply becomes the equation for uncoupled (complex) harmonic oscillators
\begin{equation}
...
Crucially, if we use some infrared regularization, Fourier modes\footnote{e.g. we would have modes $e^{\pm ikx}$ or $\sin(kx)$ for suitable $k=\2\pi(n_1/L_1,n_2/L_2,n_3/L_3)$ in a finite boxe with PBC or DBC resp. and modes $\propto R_n(r) Y_{\ell,m}(\theta,\phi)$ in a finite sphere etc} are countable discrete, we have the replacements \eqref{eq:IR_reg_replacements} and functional derivatives become
\begin{align}
    \frac{\delta}{\delta f_k} \longrightarrow \frac{V}{(2\pi)^d} \frac{\partial}{\partial f_k}\,. 
\end{align}
%
\end{mytheorem} 
...
%-------------------------------------------------------------------
%=============================================================
\section{Fluctuations of the field}
%=============================================================
%-------------------------------------------------------------------
