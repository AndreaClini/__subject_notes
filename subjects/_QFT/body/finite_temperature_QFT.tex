...
\begin{mytheorem}[Themral averages with $\tau$-dependent Hamiltonians \& symmetrized setting]
...
\begin{itemize}
    \item If the Hamiltonian $K$ is $\tau$-independent, thermal averages of single operators, or of products of equal-time $\tau$-evolved operators, are independent of $\tau$-evolution 
    {\small\begin{align}\begin{aligned}
    ...
    {\small\begin{align}\begin{aligned}
        ...
        &=
        \left\langle
            A_{1,K}(\tau_1-\tau_n)\cdots A_{n-1,K}(\tau_{n-1}-\tau_n)A_{n,K}(0)
        \right\rangle_K\,,
        \quad \tau_1,\ldots,\tau_n\in[0,\beta\hbar]\,.
    \end{aligned}\end{align}}
    In particular, since {\small$\tau,\tau'\in[0,\hbar\beta]$}, or {\small$\tau,\tau'\in[-\tfrac{\hbar\beta}{2},\tfrac{\hbar\beta}{2}]$} in the symmetrized setting, we have {\small$\tau-\tau'\in[-\hbar\beta,\hbar\beta]$}.
    %
    \item \textbf{KMS property.} For any Hamiltonian $K$ and any operators $A_1,\ldots,A_n$ and, the Kubo--Martin--Schwinger property holds:
        {\small\begin{align}\begin{aligned}
            \left\langle
                A_{1,K}(\tau_1)\cdots A_{n,K}(\tau_n)
            \right\rangle_K
        ...
        \end{aligned}\end{align}}      
    \end{itemize}
In particular, if the Hamiltonian is $\tau$-independent, combining the KMS property with the time-difference property shows that \textbf{correlators are \emph{periodic} function} over the interval $[-\hbar\beta,\hbar\beta]$.
%
\end{mytheorem}
\begin{proof}
Considering two operators for simplicity, cyclicity of the trace gives for the time-difference property
    {\small\begin{align}\begin{aligned}
        &\operatorname{Tr}\left\{
            \tfrac{e^{-\beta K}}{Z}
...
%
The KMS property actually fully identifies thermal Gibbs states: \emph{an operator $\rho$ satisfies the KMS property if and only if it is a Gibbs thermal state.}
\end{mytheorem}
\begin{proof}
Suppose that a state $\rho$ satisfies
{\small\begin{align}\begin{aligned}
...
\begin{mytheorem}[Matsubara frequencies for $\tau$-ordered correlators]
%
Operators can be evolved at times $\tau,s\in[0,\beta\hbar]$, or at times $\tau,s\in[-\beta\hbar/2,\beta\hbar/2]$ in the symmetric setting, either way the KMS property implies that correlators are functions over the interval $[-\hbar\beta,\hbar\beta]$.
A Fourier basis of $L^2([-\hbar\beta,\hbar\beta])$ is given by the Matsubara frequencies
{\small\begin{align}\begin{aligned}
    \tfrac{1}{\sqrt{2\hbar\beta}}e^{-i\omega_n \tau}\in L^2([-\hbar\beta,\hbar\beta])\,,\qquad
    \omega_n=\tfrac{2\pi n}{2\hbar\beta}=\tfrac{n\pi}{\beta\hbar}\,,\qquad n\in\mathbb Z\,. 
\end{aligned}\end{align}}
We thus expand $\tau$-ordered correlators in the basis of Matsubara frequencies as
{\small\begin{align}\begin{aligned}
    -C_{AB}^{T}(\tau-\sigma)
    &:=
    \left\langle
    ...
    \right\rangle_K
    =
    - \tfrac{1}{\beta\hbar}\sum_{n\in\mathbb Z}
    e^{-i\omega_n(\tau-\sigma)}
    \widetilde C_{AB}^{T}(i\omega_n)\,,
    \qquad
    \omega_n=\tfrac{n\pi}{\beta\hbar}\,,
\end{aligned}\end{align}}
and we extend them $2\beta\hbar$-periodically outside the interval $[-\beta\hbar,\beta\hbar]$.
...
{\small\begin{align}\begin{aligned}
    ...
    \begin{cases}
        \displaystyle
        \int_0^{\beta\hbar}\!\!\!d\rho\,
        e^{i\omega_n\rho}C_{AB}^{T}(\rho)
        &
        \begin{cases}
    ...
    \end{cases}
\end{aligned}\end{align}}
For example, density--density correlators $\langle T\{n(x)n(y)\}\rangle_K$ carry even or bosonic Matsubara frequencies, while fermionic Green functions $\langle T\{\psi(x)\psi^\dagger(y)\}\rangle_K$ carry odd or fermionic Matsubara frequencies.
Note we adopt the relativistic asymmetric convention for the Fourier transform on $[-\beta\hbar,\beta\hbar]$ namely
{\small\begin{align}\begin{aligned}
    f(t)
    &=\tfrac{1}{\beta\hbar}
    \sum_{n\in\mathbb Z}
...
\begin{mytheorem}[Time-homogeneous systems vs.\ Matsubara frequencies  \todoinline{check}]
...
\begin{mytheorem}[Matsubara coefficients for Dirac deltas of static interactions  \todoinline{check}]
...
\begin{mytheorem}[General method for Matsubara sums (Molinari 2-2020 -- 5B, 6B)  \todoinline{check}]
...
\begin{mytheorem}[Matsubara sum for the density  \todoinline{check}]
Taking
{\small\begin{align}\begin{aligned}
    f(z)
    &=
...
\begin{mytheorem}[Other Matsubara sums \& alternative methods \todoinline{check}]
