...
\end{align}
The term $\delta R_{\mu\nu} g^{\mu\nu}$ is a total derivative and vanishes by Gauss theorem assuming suitable BCs on $\delta g_{\mu\nu}$.
...
\begin{mytheorem}[Stationary and static spacetimes\todotag{finish}]
%
