...
\begin{mytheorem}[Lagrangian and Klein-Gordon equation for scalar fields]\todotag{Finish}
...
\end{align}
where $F=dA$ is the field strength 2-form, with coordinates $F_{\mu\nu} = \nabla_\mu A_\nu - \nabla_\nu A_\mu$.
...
\end{align}
where we integrated by parts using the exterior co-derivative $\delta$, which is the adjoint of $d$ wrt the Hodge inner product.
