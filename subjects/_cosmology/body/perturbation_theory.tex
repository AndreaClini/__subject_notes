...
Namely using 
\begin{align}
    P=\tfrac{k^ik^j}{k^2}-\tfrac13 \delta^{ij}, \quad (T^i_j)_{\text{scalar}}= \tfrac13 \delta^i_j T^k_k + \left(\tfrac{k^ik^j}{k^2}-\tfrac13 \delta^{ij}\right) F,\quad F=\tfrac32 \left(\tfrac{k^jk_i}{k^2}-\tfrac13 \delta^{j}_{i}\right)T^i_j,
\end{align}
We have
\begin{align}
...
\begin{align}
    ...
    = \int\!\!\frac{d^3\vec{p}}{(2\pi)^3}\,\frac{p^2}{E} \big(\mu^2-\tfrac13\big) \Big(\bar{f}-\Theta E\frac{\partial \bar{f}}{\partial E}\Big)
\end{align}
The latter integrates to 
\begin{align}
     -\int\!\!\frac{d^3\vec{p}}{(2\pi)^3}\,\frac{p^2}{E} \big(\mu^2-\tfrac13\big) \Theta E\frac{\partial \bar{f}}{\partial E} = 4 \int\!\!\frac{d^3\vec{p}}{(2\pi)^3}\,p \bar{f}\frac{1}{(4\pi)}\int d\Omega\, \tfrac23 \big(\tfrac{3\mu^2-1}{2}\big) \Theta = 4\bar{\rho}\, = 4\bar{\rho} \Big(-\tfrac23\Theta_2\Big).
\end{align}
