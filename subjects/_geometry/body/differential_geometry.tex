...
%================================================================
\subsection{Einstein tensor and energy-momentum tensor in the tetrad formalism}
%================================================================

Let us now assume $\nabla$ is the Levi-Civita connection of a Lorentzian metric $g$ on $M$ with vanishing torsion $T\equiv 0$.
The Cartan equations and Bianchi equations become
\begin{align}
    \begin{cases}
    d \theta^a + \omega^a_{\, b} \wedge \theta^b = 0,
    \\[4pt]
    ...
    \end{cases}
\end{align}
If we consider an orthonormal tetrad $e_i$, we also have antisymmetric connection 1-forms
\begin{align}
...
\end{align}
To express the Einstein equations in this formalism, it is convenient to define (0,2)-tensor valued 2-forms and (0,3)-tensor valued 1-form\todotag{check}
\begin{align}
    H^{(2)}= \theta^a \otimes \theta^b \otimes H^{ab},\quad H^{(3)} = \theta^a \otimes \theta^b \otimes \theta^c \otimes H^{abc},
\end{align}
...
\end{align}
Note the coefficient p-forms are antisymmetric in all the indices, regardless of whch are considered to be part of the form or part of the tensor.

We now want to express the Eintein equations in this formalisms...\todotag{finish}
It holds that 
\begin{align}
    \sqrt{g} \, R d^4x = \star R = H_{ab}\wedge \Omega^{ab},
\end{align}
Indeed we have
\begin{align}
    H_{ab}\wedge \Omega^{ab} &= \sqrt{g}\, g^{ia} g^{jb}\, \tfrac12 \epsilon_{ijk\ell}\, \theta^k \wedge \theta^\ell \wedge \tfrac{1}{2} R_{ab,\, mn} \theta^m \wedge \theta^n\\
    &= \tfrac{1}{4} \sqrt{g}\, g^{ia} g^{jb} R_{ab,\, mn} \epsilon_{k\ell ij}\, \theta^k \wedge \theta^\ell \wedge  \theta^m \wedge \theta^n\\
    &\sqrt{g}\, R d^4x.
\end{align}

%First note that the Einstein_Hilbert action can be expressed as
% \begin{align}
%     S_{EH}[g] = \frac{1}{16\pi G}\int_M d\Omega_g\,\,(R-2\Lambda) 
