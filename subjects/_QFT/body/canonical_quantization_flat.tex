...
\begin{itemize}
    ...
    \item \textbf{Resonance.} What is the best choice of $J(t)$ to excite the oscillator? It is the natural frequency $\omega$ of the oscillator, as shown by the two previous points, and as expected from the \emph{classical} case.
...
\begin{align}
    ...
    \\
    = &\sqrt{\frac{\hbar}{2 m \omega}}\,\,\, {}_{\mathrm{in}}\langle 0 | \bigg(\graycancel{a_{\mathrm{in}} e^{-i\omega (t-t_0)} }  - \frac{i}{\hbar} \int_{t_i}^t dt' \sqrt{\tfrac{\hbar}{2 m \omega}} J(t') e^{-i\omega (t-t')}\bigg) + \text{h.c.} | 0 \rangle_{\mathrm{in}}
    \\
...
Indeed, the bigger the interval $t_f-t_i$ the more the wannabe Fourier transform above matches $\tilde{J}(\omega)$.
...
\begin{align}
    ...
    \\[5pt]
    &= \hbar \omega \left(|J_0|^2 + \tfrac{1}{2}\right),\qquad |J_0|^2 = \frac{1}{2 m \omega \hbar} \left|\int_{t_i}^{t_f} dt' J(t') e^{i\omega t'}\right|^2 \sim \frac{1}{2 m \omega \hbar} |\tilde{J}(\omega)|^2.
\end{align}
