...
A primary example if inflation, that modifies frequencies of oscillators up to turning some of them upside-down leading to run-away solutions.
%
\end{mytheorem}
...
General in states have overlap with out-states given by
{\small
\begin{align}
