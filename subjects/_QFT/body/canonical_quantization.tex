...
\begin{align}
    \mathcal{F}=\bigoplus_{n=0}^\infty \mathcal{H}_1^{\otimes^n}=\bigotimes_{k\,\in\mathrm{modes}}\mathcal{M}_k\,.
\end{align}
%
...
\begin{align}
    ...
    &= \left( \frac{m \omega_k}{\pi \hbar} \right)^{\frac{1}{2}} \frac{1}{2^{n_k} n_k!} \left[ H_{n_k}\left( \sqrt{\frac{m \omega_k}{\hbar}} \phi_{k} \right) \right]^2 e^{-\frac{m \omega_k}{\hbar} \phi_{k}^2} \,d\phi_k.
\end{align}
...
\begin{align}
    ...
    \\
    &= \prod_k \left( \frac{m \omega_k}{\pi \hbar} \right)^{\frac{1}{2}} \frac{1}{2^{n_k} n_k!} \left[ H_{n_k}\left( \sqrt{\frac{m \omega_k}{\hbar}} \phi_{k} \right) \right]^2 e^{-\frac{m \omega_k}{\hbar} \phi_{k}^2} \,d\phi_k,
\end{align}
...
\begin{align}
    ...
    \\
    &= \prod_k \left( \frac{m \omega_k}{\pi \hbar} \right)^{\frac{1}{2}} \frac{1}{2^{n_k} n_k!} \left[ H_{n_k}\left( \sqrt{\frac{m \omega_k}{\hbar}} f_{k} \right) \right]^2 e^{-\frac{m \omega_k}{\hbar} f_{k}^2} \,Df,
\end{align}
