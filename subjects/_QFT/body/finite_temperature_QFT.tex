...
{\small\begin{align}\begin{aligned}
    (c_a)_K(\tau)&=e^{-\tfrac{\tau}{\hbar}(\epsilon_a-\mu)}c_a\,,
    &
    (c_a^\dagger)_K(\tau)&=e^{\tfrac{\tau}{\hbar}(\epsilon_a-\mu)}c_a^\dagger\,.
\end{aligned}\end{align}}
...
Thermal averages of single operators, or of products of equal-time $\tau$-evolved operators, are independent of $\tau$-evolution if the Hamiltonian $K$ is $\tau$-independent:
{\small\begin{align}\begin{aligned}
    ...
    =\langle A\rangle_K\,.
\end{aligned}\end{align}}
If $K$ is time-independent, correlators depend only on time differences:
{\small\begin{align}\begin{aligned}
...
\begin{mytheorem}[KMS property for correlators (Molinari 2-2020 -- 5A)]
For any operators $A_1,\ldots,A_n$ and any thermal Hamiltonian $K$, the Kubo--Martin--Schwinger property reads
{\small\begin{align}\begin{aligned}
    \left\langle
        (A_1)_K(\tau_1)\cdots(A_n)_K(\tau_n)
    \right\rangle_K
    &=
    \left\langle
        (A_n)_K(\tau_n+\beta\hbar)
        (A_1)_K(\tau_1)\cdots(A_{n-1})_K(\tau_{n-1})
    \right\rangle_K\,,
    \\
    &\hspace{8em}\tau_1,\ldots,\tau_n\in[0,\beta\hbar]\,.
\end{aligned}\end{align}}
For two operators, this follows directly from cyclicity of the trace:
{\small\begin{align}\begin{aligned}
...
The KMS property also characterizes thermal Gibbs states.
Suppose that a state $\rho$ satisfies
{\small\begin{align}\begin{aligned}
    \operatorname{Tr}\{\rho A(\tau)B(\tau')\}
    &=
    \operatorname{Tr}\{\rho B(\tau'+\beta\hbar)A(\tau)\}
\end{aligned}\end{align}}
for every pair of operators and every pair of parameters.
...
{\small\begin{align}\begin{aligned}
    ...
    &=0\,.
\end{aligned}\end{align}}
The non-degeneracy of the Hilbert--Schmidt inner product implies
{\small\begin{align}\begin{aligned}
    B\rho-\rho B(\beta\hbar)&=0\,,
    &
    [B,\rho e^{\beta K}]&=0
    \qquad\text{for every }B\,.
\end{aligned}\end{align}}
Therefore $\rho e^{\beta K}$ is a multiple of the identity, so $\rho$ is the Gibbs thermal state.
\end{mytheorem}
...
=
    \tfrac{
        \Big\langle
            T\big\{
                U_I(\beta\hbar,0)
                (A_1)_{K_0}(\tau_1)\cdots(A_n)_{K_0}(\tau_n)
            \big\}
        \Big\rangle_{K_0}
    }{
