...
\begin{mytheorem}[Energy-momentum tensor of continuum distributions \& Bianchi conservation laws\todotag{Finish \& polish}]
...
The general matter action is written as, where $\phi_{a,\bullet}^{\star}$ carries arbitray spin indices and the dependence is on $\nabla_\mu$ and not just $\partial_\mu$ to ensure covariance,
\begin{align}
...
In full generality, by the chain rule we have
\begin{align}
...
\end{align}
The general form of energy-momentum tensor for some matter species is then
{\small
\begin{align}
    T_{\mu\nu} &= -\frac{2}{\sqrt{|g|}}\, \frac{\delta S_\text{mat}}{\delta g^{\mu\nu}}= -\frac{2}{\sqrt{|g|}} \frac{\mathrm{d\,}}{\,\mathrm{d} g^{\mu\nu}} \left(\sqrt{|g|} \,\,\mathcal{L}(g,\phi,\nabla \phi)\right)
    = -\frac{2}{\sqrt{|g|}} \left[ \sqrt{|g|} \,\,\frac{\mathrm{d} \mathcal{L}\,\,}{\mathrm{d} g^{\mu\nu}} -\frac{1}{2}\sqrt{|g|}\,g_{\mu\nu}\,\mathcal{L} \right]
    \\[4pt]
...
The same argument could be done explicitating covariant derivatives in terms of locale frames and spin  connection forms $\omega_a^b$, and differentiating them wrt the metric $\frac{d\omega_a^b}{d g^{\mu\nu}}$.
In fact, it is possibly more transparent when using non-tensorial (i.e. not integer spin) fields like spinors.
...
\begin{mytheorem}[General form of  energy-momentum tensor]
%
The general matter action is written
\begin{align}
    S=\int d^n x \sqrt{|g|} \,\mathcal{L}(\phi_{a,\bullet}^{\star},\nabla_\mu \phi_{a,\bullet}^{\star}, g_{\mu\nu})\,.
\end{align}
The dependence on the metric $g_{\mu\nu}$ can thus be both explicit and implicit through the covariant derivatives $\nabla_\mu \phi^\star_{a,\bullet}\simeq \partial_\mu \phi^\star_{a,\bullet} -\Gamma_{\mu \#}^\star \,\phi^{\#}_{a,\bullet} + \Gamma_{\mu\bullet}^{\#}\,\phi^\star_{a,\#}$ which contains the Christoffel symbols which in turn depend on the metric and its first derivatives.
In full generality we have
\begin{align}
    \frac{\partial \nabla_\mu \phi^\star_{a,\bullet}}{\partial g_{\rho\sigma}}= \frac{\partial \nabla_\mu \phi^\star_{a,\bullet}}{\partial \Gamma_{\alpha\beta}^\gamma} \frac{\partial \Gamma_{\alpha\beta}^\gamma}{\partial g_{\rho\sigma}}.
\end{align}
The energy-momentum tensor is thus given by
{\small
\begin{align}
    T_{\mu\nu} &= -\frac{2}{\sqrt{|g|}}\, \frac{\delta S_\text{mat}}{\delta g^{\mu\nu}}= -\frac{2}{\sqrt{|g|}} \frac{\mathrm{d\,}}{\,\mathrm{d} g^{\mu\nu}} \left(\sqrt{|g|} \,\,\mathcal{L}(g,\phi,\nabla \phi)\right)
    = -\frac{2}{\sqrt{|g|}} \left[ \sqrt{|g|} \,\,\frac{\mathrm{d} \mathcal{L}\,\,}{\mathrm{d} g^{\mu\nu}} -\frac{1}{2}\sqrt{|g|}\,g_{\mu\nu}\,\mathcal{L} \right]
