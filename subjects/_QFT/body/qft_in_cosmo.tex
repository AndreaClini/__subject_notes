...
\end{aligned}\end{align}
Notably these generators realize the $\mathfrak{su}(1,1)$ algebra after the standard identification
\begin{align}
\begin{aligned}
...
\end{aligned}\end{align}
This operator is not unitary so it cannot be the full scattering operator relating the two theories.
Indeed, it is natural to consider the folowing ansatz for the scattering operator, which is unitary by construction, for a suitable $\eta$ to be determined in terms of $\xi$,
\begin{align}
\begin{aligned}
...
\end{aligned}\end{align}
Indeed, since $A|0\rangle=0$ and $M|0\rangle=\tfrac12 |0\rangle$, we can freely add such exponential factors to the right of $e^{\xi^* C}$ without changing its action on the vacuum, 
\begin{align}
\begin{aligned}
...
Take the $2\times2$ representation of this algebra
\begin{align}
\begin{aligned}
...
\end{aligned}\end{align}
Since its square is $(\eta^*C-\eta A)^2=|\eta|^2\,\mathbf 1$, we find
{\small
\begin{align}
\begin{aligned}
...
\end{aligned}\end{align}}
Matching to the above expression for $S(\eta)$ we find a unique solution
{\small\begin{align}
\begin{aligned}
