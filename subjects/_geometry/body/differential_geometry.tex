...
Let us now assume torsion vanishes $T\equiv 0$ and $\nabla$ is the Levi-Civita connection of a Lorentzian metric $g$ on $M$.
...
\end{align}
And if the tetrad is related to some coordinate system $x^\mu$ by $e_i = B_i^\mu \partial_\mu$, we express the Crhsitoffel symbols as
\begin{align}
\begin{aligned}
...
\end{align}
It wil be convenient to define a (0,2) tensor valued 2-form\todotag{Check def \& name}
\begin{align}
