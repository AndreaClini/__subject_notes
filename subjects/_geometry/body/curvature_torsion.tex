...
Weak
&
Freely falling test bodies follow the same trajectories independently of composition and internal structure. Equivalently, \(m_{\rm inertial}=m_{\rm gravitational}\).
&
