...
\begin{mytheorem}[Review of classical \& quantum harmonic oscillator\questioninline{Check \& improve}]
%
...
\begin{align}\label{eq:oscillator_hamiltonian_written_ladder_operators}
    a &= \frac{1}{\sqrt{2}}\left(\sqrt{\frac{m\omega}{\hbar}}\, q + i \frac{1}{\sqrt{m \omega \hbar}}\, p\right), \quad [a, a^\dagger] = 1,\\[2.5pt]
...
Denote the time-evolution operator $U(t,s)=\mathcal{T}\exp\left(\int_s^t\!\!dt'H_S(t')\,\right)$.
