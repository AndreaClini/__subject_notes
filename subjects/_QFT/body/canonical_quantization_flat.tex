...
\end{align}
After tracing out the EM field degrees of freedom, the electron is thus left in a pure state evolving under the free Hamiltonian augmented with a classical EM field $B^{cl}(t,\mathbf{x})$.
%
\end{mytheorem}
