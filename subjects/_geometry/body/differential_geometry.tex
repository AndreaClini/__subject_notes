...
In fact, for a general fiber bundles $E_F$ the first line is the \emph{only definition} of torsion, while it coincides with the usual torsion tensor in case $E_F = TM$ is the tangent bundle.
