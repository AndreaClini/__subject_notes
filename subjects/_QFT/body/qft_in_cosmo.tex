...
{\small\begin{align}
    ...
    \begin{pmatrix}\tilde{a}_m\\ \tilde{a}_m^\dagger \end{pmatrix}.
\end{align}}
Under the Stone--von Neumann assumptions, the Fock spaces of the two theories are unitarily equivalent via a transformation mapping the corresponding quantum DoFs into each other.
