...
\begin{align}
    |\bm{\beta} \rangle = e^{-\frac{|\beta|^2}{2}} \sum_{\mathbf{n}} \left(\prod_k\frac{\beta_k^{n_k}}{\sqrt{n_k!}}\right) |\mathbf{n}\rangle \quad \Rightarrow \quad
    \langle \mathbf{n} | \bm{\beta} \rangle = e^{-\frac{|\beta|^2}{2}} \left(\prod_k\frac{\beta_k^{n_k}}{\sqrt{n_k!}}\right)\,.
\end{align}
