...
\@ifundefined{IfSubfilesClassLoaded}{%
  % Fallback: treat documents using the subfiles class as "loaded", otherwise "not loaded"
  \@ifclassloaded{subfiles}{%
    \newcommand{\IfSubfilesClassLoaded}[2]{#1}%
  }{%
    \newcommand{\IfSubfilesClassLoaded}[2]{#2}%
  }%
}{}
\makeatother
...
%------------ Table of Contents --------------
\usepackage{tocloft}
\setlength{\cftchapnumwidth}{1.3em}   % space between chapter number and title
\setlength{\cftsecnumwidth}{1.0em}    % space between section number and title
\setlength{\cftsubsecnumwidth}{1.5em}    % space between subsection number and title
\setlength{\cftsubsubsecnumwidth}{2.0em} % space between subsubsection number and title

\renewcommand{\cftpartfont}{\Large\bfseries}
\renewcommand{\cftpartpagefont}{\Large\bfseries}
\setcounter{tocdepth}{3}  % show subsubsections in the table of contents

%----------- Section and chapter styles --------------
\usepackage{titlesec}

\titleformat{\chapter}[hang]{\huge\bfseries}{\thechapter}{0.5em}{} % remove "Chapter" from chapter titles
...
\newenvironment{abstract}{% simple abstract env for classes that lack it
...
%-------------------personalized theorem environments--------------------------
% Bold, unnumbered "theorem" heading driven by the optional argument
...
\numberwithin{equation}{chapter} % numbering reference for equations
