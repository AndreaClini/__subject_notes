...
\begin{mytheorem}[The rise of Quantume Mechanics.]
...
\begin{mytheorem}[The idea of second quantization: from relativistic QM to quantum field theory\todotag{finish}]
...
\begin{mytheorem}[What is a quantum field theory? (Matheus 2.1)]
Ultimately a quantum field theory is a quantum theory where the fundamental DoFs are fields $\phi(x)$.
When writing a quantum field theory to model a system we ultimately have two ingredients:
\begin{itemize}
    \item \textbf{The DoFs.} We need to identify the relevant DoFs of the system, which are typically fields $\phi(x)$.
    \item \textbf{The symmetries.} We need to identify the symmetries of the system, which are typically encoded in the transformation properties of the fields under certain symmetry groups.
    ...
    \item \textbf{The dynamics.} We need to specify the dynamics of the system, which is typically done by writing down a Lagrangian or Hamiltonian for the fields, consistent with the symmetries of the system.
\end{itemize}
\end{mytheorem}