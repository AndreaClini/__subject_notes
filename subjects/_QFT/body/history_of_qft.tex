...
%
A first attempt to address the limitations of Quantum Mechanics was the development of relativistic quantum mechanics, which aimed to combine the principles of quantum mechanics with special relativity.
The idea is simply to promote the Schr\"odinger equation to a relativistic equation, such as the Klein-Gordon or Dirac equations, without enforcing the second quantization procedure i.e. the wave function is still a c-number and not an operator.
...
These issues highlighted the need for a more comprehensive framework, ultimately leading to the development of Quantum Field Theory, which treats fields as the fundamental entities and allows for the creation and annihilation of particles. \todotag{Insert scheme cf Matheus 1.3}
\end{mytheorem}
