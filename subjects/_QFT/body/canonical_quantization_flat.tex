...
For example, in the case of the electromagnetic field possible interactions would be with the momentum or the spin of the detector
\begin{align}
...
\end{align}
Up to an irrelevant overall phase depending on the initial time $\tau_0$, the freely time evolved field is 
\begin{align}
    \phi^I(x(\tau'),\tau_0) &= e^{\frac{i}{\hbar} \hat{H}_{\phi} (\tau'-\tau_0)} \hat{\phi}(x(\tau')) e^{-\frac{i}{\hbar} \hat{H}_{\phi} (\tau'-\tau_0)} = \int \frac{d^3\bar{k}}{(2\pi)^3} \frac{1}{\sqrt{2\omega_k}} \left( a_k e^{-i k_\mu x^\mu(\tau')} + a_k^{\dagger} e^{i k_\mu x^\mu(\tau')} \right).
\end{align}
